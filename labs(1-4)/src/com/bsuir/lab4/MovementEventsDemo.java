...
public class MovementEventsDemo extends Application {
    ...
    private static final int      KEYBOARD_MOVEMENT_DELTA = 7;
    ...
    public void start(Stage stage) throws Exception {
        ...
        final Scene scene = new Scene(group, 600, 400, Color.ALICEBLUE);
    ...
    private Circle createCircle() {
        final Circle circle = new Circle(200, 150, 50, Color.BLACK);
